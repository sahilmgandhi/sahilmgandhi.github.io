...
\resumeSubHeadingListStart
	...
	\resumeSubItem{Frameworks and Technologies}{Kubernetes, Docker, Protobuf, Vert.x, Helm, Vault, Terraform, AWS, GCP, AZURE, SQL, PostgreSQL, OpenTelemetry, OpenCensus, DataDog, NewRelic React, RocksDB, Git, Mercurial, UNIX}
\resumeSubHeadingListEnd
