...
\resumeSubHeadingListStart
	...
	\resumeSubItem{Frameworks and Technologies}{Kubernetes, Docker, Protobuf, Vert.x, Helm, Vault, Terraform, AWS, GCP, AZURE, SQL, PostgreSQL, OpenTelemetry, OpenCensus, DataDog, NewRelic, UNIX, React, RocksDB, Git, Mercurial}
\resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItemOne{Designed interface to transfer Flink compute pools between Kubernetes, boosting utilization through pool colocation and enhancing disaster recovery for Kubernetes failures}
    \resumeItemListEnd
    \resumeSubheadingTitleOnly
