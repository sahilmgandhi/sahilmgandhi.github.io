...
\resumeSubHeadingListStart
    ...
    \resumeSubheadingCompanyOnly {Sierra}
    \resumeSubheadingTitleOnly
    {Staff Software Engineer - Voice LLM Infrastructure and Product}{Dec 2025 - Present}
    \resumeItemListStart
      \resumeItemOne{Building the foundational platform for Sierra's generative AI voice services}
    \resumeItemListEnd

    \resumeSubheadingCompanyOnly {Confluent}
    \resumeSubheadingTitleOnly
    {Staff Software Engineer}{November 2025 - December 2025}
    \resumeSubheadingTitleOnly
    {Senior Software Engineer II - Compute Platform and Capacity}{June 2023 - November 2025}
     \resumeItemListStart
      \resumeItemOne{Tech lead for a regional multi-k8s deployment framework to support the next generation regional Confluent Kora Engine}
      \resumeItemListStart
      ...
      \resumeItemOne{Developed scaffolding Terraform components for seamless migration of monitors and dashboards from Datadog to NewRelic}
...
{Patent}{Container Orchestration Using Siloed Availability Zones}{12639100}
...
\resumeSubheadingActivityCustom
{Blog Post}{Sahil Gandhi, Subbu G, Chaoqun Chen, Godwin Pang: Migrating\\ \hspace{0.6cm} Confluent Cloud’s Most Critical Services into a New Deployment Management Platform} {2022}
...
\resumeSubheadingActivityCustom
{[1]}{Sahil M. Gandhi: Xldb - Execution Log DataBase. UCLA}{2019}

\resumeSubheadingActivityCustom
{[2]}{Sahil M. Gandhi, Max Wang, Daniel Achee: IoTShark - Monitoring and Analyzing IOT Traffic. UCLA}{2019}

\resumeSubheadingActivityCustom
{[3]}{Sahil M. Gandhi, Kaushik Mahorker, Wenlong Xiong: SIKE: An Analysis of \\ \hspace{0.7cm} Serializing Interfaces in Kafka Experiments. UCLA}{2019}

\resumeSubheadingActivityCustom
{[4]}{Ariyam Das, Jin Wang, Sahil M. Gandhi: Learn Smart with Less: Building Better\\ \hspace{0.7cm}Online Decision Trees with Fewer Training Examples. IJCAI}{2019}

\resumeSubheadingActivityCustom
{[5]}{Sahil M. Gandhi, Matthew Wong: Parallel Kernel Execution on GPUs. UCLA}{2019}

\resumeSubheadingActivityCustom
{[6]}{Ariyam Das, Sahil M. Gandhi, Carlo Zaniolo: ASTRO: A Datalog System for Advanced \\ \hspace{0.6cm} Stream Reasoning. CIKM 1863-1866}{2018}
